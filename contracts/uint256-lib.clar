...
(define-read-only (hex-to-uint256 (a (buff 32)))
  (ok
    (tuple
      (i0 (buff-to-int-be (try! (read-uint64 a u0 u8))))
      (i1 (buff-to-int-be (try! (read-uint64 a u8 u8))))
      (i2 (buff-to-int-be (try! (read-uint64 a u16 u8))))
      (i3 (buff-to-int-be (try! (read-uint64 a u24 u8))))
    )
  )
)
